...
DEFAULTS_CHANNEL_ALIASES = {"defaults", "main"}
...
DEFAULT_CHANNELS = []  # This is now handled by the "EnvironmentConfig" object
...
COMPATIBLE_SHELLS = tuple()  # This is now handle by EnvironmentConfig
...
# Commenting out for now because of import errors
# Here for reference purpose only
